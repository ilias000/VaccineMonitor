...
void commandInterface(LinkedListString*, LinkedListString*, LinkedListCitizen*, LinkedListBloomFilter*, SkipList*); // its the interface for the commands that the user can give
#endif