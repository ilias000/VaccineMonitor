...
public:
    ...
    int insertNodeCommand(CitizenRecord**);      // inserts a node at the rigth place so the list is sorted with smaller ides first (returns a specific number so i know what happend at the CommandInterface function)
