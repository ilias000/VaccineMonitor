...
- Αν πρέπει να φτιάξω πάνω από 10.000 records και έχω ήδη χρησιμοποιήσει 10.000 διαφορετικά id είτε θέλει ο χρήστης duplicate είτε όχι τα υπόλλοιπα records θα είναι duplicate γιατί δεν έχω άλλα id να χρησιμοποιήσω.
